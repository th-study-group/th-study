...
return [
    ...
    'topics' => [
        ...
        ['group_code' => 'blog', 'category_code' => 'develop', 'name' => '스프링부트', 'memo' => '자바 스프링부트 대해서 정리해요.'],
        ['group_code' => 'blog', 'category_code' => 'develop', 'name' => '몽고DB', 'memo' => '몽고DB NoSQL 대해서 정리해드려요.'],
        ['group_code' => 'blog', 'category_code' => 'develop', 'name' => 'ERP/MES', 'memo' => 'ERP와 MES 개발에 대해 해드려요.'],
        ...
        ['group_code' => 'blog', 'category_code' => 'life', 'name' => '일상', 'memo' => '일상속 쇼핑 구매 후기'],
        ['group_code' => 'blog', 'category_code' => 'life', 'name' => '생활상식', 'memo' => '생활 속 상식 정보 정리해드려요.'],
    ],
];
