                    ...
                    <div class="text-center fs-3 fw-bold text-secondary mb-4" style="letter-spacing: 0;">Password</div>
                        ...
                        @if ($errors->any())
                            <div class="alert alert-warning d-flex align-items-center gap-2 small mb-4" role="alert">
                                ...
                                <span>비밀번호 변경 실패 사유를 확인해주세요.</span>
                            </div>
                        @endif

                        <form id="form_password_reset" name="form_password_reset" method="POST" action="{{ route('users.account.password_reset.request') }}">
                            @csrf
                            @method('PATCH')
                            <div class="w-100">
                                ...
                                <div class="mb-4">
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label" for="password_reset_confirm">
                                            위 내용을 확인하였으며, 비밀번호 변경을 진행합니다. <span class="text-danger fw-bold">(필수)</span>
                                        </label>
                                    </div>
                                ...
                                <button type="button" id="btn_reset_password" class="btn btn-dark border-0 w-100">비밀번호 변경 하기</button>
                            </div>
                        </form>
                    </div>
                </section>
