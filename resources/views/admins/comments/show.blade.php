                ...
                <div class="comment-item border rounded-3 p-3 mb-2">
                    <div class="d-flex justify-content-between align-items-start gap-2">
                        ...
                        <div class="comment-actions d-flex gap-1">
                            ...
                            <form class="form_delete_comment d-inline" method="POST" action="{{ route('admins.comments.soft.delete', ['idx' => $comment->idx]) }}">
                                @csrf
                                @method('DELETE')
                    ...
                    <div class="comment_edit_inline border-top pt-3 mt-3 {{ $openCommentEditIdx === $comment->idx ? '' : 'd-none' }}">
                        ...
                        <form class="form_update_comment comment-form" method="POST" action="{{ route('admins.comments.update', ['idx' => $comment->idx]) }}">
                            @csrf
                            @method('PUT')
                            <div class="mb-2">
                                <textarea
