    ...
    <main class="container-fluid px-3 px-lg-4 py-4 flex-grow-1">
        <section class="p-4 p-lg-5 rounded-3 shadow-sm" style="background:#f1e8dd; border:1px solid #e2d4c3;">
            ...
            <ol class="mb-4">
                ...
                <li class="mb-3">
                    <strong>ChatGPT 앱 및 MCP 서비스 이용</strong>
                    <ul class="mb-0">
                        <li>티에이치스터디는 ChatGPT 앱 및 MCP(Model Context Protocol) 서비스를 통해 일부 기능을 제공할 수 있습니다.</li>
                        <li>사용자가 ChatGPT를 통해 티에이치스터디 서비스에 연결하는 경우, 서비스 제공 및 사용자 인증을 위해 계정 식별 정보, 인증 정보, 요청 데이터 및 서비스 이용 로그가 처리될 수 있습니다.</li>
                        <li>수집된 정보는 사용자 인증, 서비스 제공, 보안 유지, 오류 분석 및 서비스 개선 목적으로만 이용되며, 관련 법령에 따라 안전하게 관리됩니다.</li>
                        <li>티에이치스터디는 이용자의 개인정보를 관련 법령에 따른 경우를 제외하고 제3자에게 제공하지 않습니다.</li>
                    </ul>
                </li>
            </ol>
