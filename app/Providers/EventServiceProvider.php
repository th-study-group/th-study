...
use App\Listeners\WriteNoteHistoryEventListener;
use App\Listeners\WritePushLogEventListener;
...
class EventServiceProvider extends ServiceProvider
{
    ...
    protected $listen = [
        ...
        PushSentEvent::class => [
            WritePushLogEventListener::class,
        ],
        PostHistoryEvent::class => [
            WritePostHistoryEventListener::class,
        ],
        NoteHistoryEvent::class => [
            WriteNoteHistoryEventListener::class,
        ],
    ];
